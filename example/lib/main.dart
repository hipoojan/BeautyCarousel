...
import 'package:beauty_carousel/beauty_carousel.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Beauty Carousel',
      home: FlutterCarouselExample(),
    );
  }
}

class FlutterCarouselExample extends StatefulWidget {
  @override
  _FlutterCarouselExampleState createState() => _FlutterCarouselExampleState();
}

class _FlutterCarouselExampleState extends State<FlutterCarouselExample> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
